...
<body>
    ...
    <section class="hero">
        <div class="container text-center">
            ...
            <div class="mt-5">
                <a href="{{ route('login') }}" class="btn btn-lg btn-login px-5 py-3">
                    <i class="fas fa-user-lock"></i> Ingresar al sistema
                </a>
            </div>
            <div class="row justify-content-center mt-5">
                <div class="col-md-6 text-center">
                    <a href="{{ route('public.consult') }}" class="btn btn-primary btn-lg w-100 py-3 shadow">
    ...
    <footer class="py-3">
        <div class="container text-center">
            <small>
                © {{ date('Y') }} HEAVY GLASS — Sistema de Gestión de Centro de Colisiones Vehiculares
                <br>
