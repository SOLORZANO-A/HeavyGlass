...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="engine_number" class="form-control" value="<?php echo e(old('engine_number')); ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="chassis_number" class="form-control" value="<?php echo e(old('chassis_number')); ?>">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HeavyGlass-main\resources\views/vehicles/create.blade.php ENDPATH**/ ?>