<?php $__env->startSection('title', 'Hojas de ingreso'); ?>
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-md-8">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" placeholder="Buscar por cliente, placa o fecha..."
                            data-table-filter="intake-table">
                    </div>
                </div>

                <!-- Botón -->
                <div class="col-md-4 text-end">
                    <a href="<?php echo e(route('intake_sheets.create')); ?>" class="btn btn-primary">
                        <i class="fas fa-plus me-1"></i> Nueva Hoja de Ingreso
                    </a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HeavyGlass-main\resources\views/intake_sheets/index.blade.php ENDPATH**/ ?>