...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="reference_number" class="form-control" value="<?php echo e(old('reference_number')); ?>">
                    </div>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <option value="insurance" <?php echo e(old('client_type') == 'insurance' ? 'selected' : ''); ?>>
                                Aseguradora
                            </option>
                        </select>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HeavyGlass-main\resources\views/clients/create.blade.php ENDPATH**/ ?>