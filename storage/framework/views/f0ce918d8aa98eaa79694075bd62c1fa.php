            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo e($client->reference_number ?? '—'); ?></td>
                    </tr>
                    <tr>
                        
                        <th>Tipo Cliente</th>
                        <td><?php echo e($staffTypeLabels[$client->client_type] ?? ucfirst($client->client_type)); ?></td>
                    </tr>
                    <tr>
                        <th>Descripcion</th>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\HeavyGlass-main\resources\views/clients/show.blade.php ENDPATH**/ ?>